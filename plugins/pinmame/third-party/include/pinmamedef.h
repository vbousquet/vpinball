...
typedef enum {
   ...
   PINMAME_SEG_LAYOUT_8,          //  7 segments and comma
   PINMAME_SEG_LAYOUT_8D,         //  7 segments and dot
   PINMAME_SEG_LAYOUT_9,          //  9 segments
   PINMAME_SEG_LAYOUT_10,         //  9 segments and comma
   PINMAME_SEG_LAYOUT_14,         // 14 segments (correspond to CORE_SEG16N)
   PINMAME_SEG_LAYOUT_15,         // 14 segments with dot (correspond to CORE_SEG16D)
   PINMAME_SEG_LAYOUT_16,         // 14 segments with dot and comma (correspond to CORE_SEG16)
   PINMAME_SEG_LAYOUT_16R,        // 14 segments with swapped dot and comma (correspond to CORE_SEG16R)
   PINMAME_SEG_LAYOUT_16S,        // 16 segments (correspond to CORE_SEG16S)
