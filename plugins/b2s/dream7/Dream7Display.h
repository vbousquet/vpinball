...
public:
   ...
   void SetType(const SegmentNumberType segmentNumberType)
   {
      if (m_type != segmentNumberType)
      {
         m_type = segmentNumberType;
         InitSegmentsStyle();
      }
   }
   ...
   void SetShear(const float shear)
   {
      if (m_shear != shear)
      {
         m_shear = shear;
   ...
   void SetOffsetWidth(const int offsetWidth)
   {
      if (m_offsetWidth != offsetWidth)
      {
