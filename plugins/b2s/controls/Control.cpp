...
bool Control::IsVisible() { return m_visible && (!m_pParent || m_pParent->IsVisible()); }
...
void Control::SetBackgroundImage(Texture* pBackgroundImage)
{
...
void Control::Refresh() { m_invalidated = true; }

void Control::Invalidate() { m_invalidated = true; }
