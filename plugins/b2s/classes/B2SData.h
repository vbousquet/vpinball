...
public:
   ...
   std::map<int, std::map<int, Texture*>>* GetRotatingImages() { return &m_rotatingImages; }
   ...
   GenericDictionaryIgnoreCase<Texture*>* GetReelImages() { return &m_reelImages; }
   GenericDictionaryIgnoreCase<Texture*>* GetReelIntermediateImages() { return &m_reelIntermediateImages; }
   GenericDictionaryIgnoreCase<Texture*>* GetReelIlluImages() { return &m_reelIlluImages; }
   GenericDictionaryIgnoreCase<Texture*>* GetReelIntermediateIlluImages() { return &m_reelIntermediateIlluImages; }
...
private:
   ...
   std::map<int, std::map<int, Texture*>> m_rotatingImages;
   ...
   GenericDictionaryIgnoreCase<Texture*> m_reelImages;
   GenericDictionaryIgnoreCase<Texture*> m_reelIntermediateImages;
   GenericDictionaryIgnoreCase<Texture*> m_reelIlluImages;
   GenericDictionaryIgnoreCase<Texture*> m_reelIntermediateIlluImages;
