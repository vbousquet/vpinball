...
B2SAnimationBase::B2SAnimationBase(eDualMode dualMode, int interval, eType type, int loops, bool playReverse, bool startMeAtVPActivate,
   ...
   bool hideScoreDisplays, bool bringToFront, bool randomStart,
