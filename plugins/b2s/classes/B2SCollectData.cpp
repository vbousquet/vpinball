...
B2SCollectData::B2SCollectData(int skipFrames) { m_skipFrames = skipFrames; }
...
void B2SCollectData::DataAdded() { m_skipFrames--; }

bool B2SCollectData::ShowData() const { return (m_skipFrames < 0); }
...
void B2SCollectData::Lock() { m_mutex.lock(); }

void B2SCollectData::Unlock() { m_mutex.unlock(); }
