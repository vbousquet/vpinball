...
PictureBoxAnimation::PictureBoxAnimation(Form* pForm, Form* pFormDMD, const string& szName, eDualMode dualMode, int interval, int loops, bool startTimerAtVPActivate,
   ...
   : B2SAnimationBase(dualMode, interval, eType_ImageCollectionAtForm, loops, false, startTimerAtVPActivate, lightsStateAtAnimationStart, lightsStateAtAnimationEnd, animationStopBehaviour,
