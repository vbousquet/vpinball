...
B2SData::B2SData()
{
   ...
   m_led10Seg.push_back({ { 22 - 2 * toleft, 95 }, { 29 - 2 * toleft, 89 }, { 61 - 2 * toleft, 89 }, { 66 - 2 * toleft, 94 }, { 71 - 2 * toleft, 89 }, { 85 - 2 * toleft, 89 },
      { 92 - 2 * toleft, 95 }, { 88 - 2 * toleft, 98 }, { 26 - 2 * toleft, 98 } });
   ...
   m_led10Seg.push_back({ { 23 - toleft, 50 }, { 27 - toleft, 46 }, { 63 - toleft, 46 }, { 68 - toleft, 51 }, { 73 - toleft, 46 }, { 86 - toleft, 46 }, { 90 - toleft, 50 },
      { 86 - toleft, 54 }, { 72 - toleft, 54 }, { 67 - toleft, 49 }, { 62 - toleft, 54 }, { 27 - toleft, 54 } });
...
bool B2SData::IsLampsData() const { return m_valid && (IsUseRomLamps() || IsUseAnimationLamps()) && !m_pB2SSettings->IsAllOff() && !m_pB2SSettings->IsLampsOff(); }

bool B2SData::IsSolenoidsData() const { return m_valid && (IsUseRomSolenoids() || IsUseAnimationSolenoids()) && !m_pB2SSettings->IsAllOff() && !m_pB2SSettings->IsSolenoidsOff(); }

bool B2SData::IsGIStringsData() const { return m_valid && (IsUseRomGIStrings() || IsUseAnimationGIStrings()) && !m_pB2SSettings->IsAllOff() && !m_pB2SSettings->IsGIStringsOff(); }

bool B2SData::IsLEDsData() const { return m_valid && (IsUseLEDs() || IsUseLEDDisplays() || IsUseReels()) && !m_pB2SSettings->IsAllOff() && !m_pB2SSettings->IsLEDsOff(); }
...
bool B2SData::IsUseAnimationLamps() const { return (!m_usedAnimationLampIDs.empty() || !m_usedRandomAnimationLampIDs.empty()); }

bool B2SData::IsUseAnimationSolenoids() const { return (!m_usedAnimationSolenoidIDs.empty() || !m_usedRandomAnimationSolenoidIDs.empty()); }

bool B2SData::IsUseAnimationGIStrings() const { return (!m_usedAnimationGIStringIDs.empty() || !m_usedRandomAnimationGIStringIDs.empty()); }

bool B2SData::IsUseRomReelLamps() const { return (!m_usedRomReelLampIDs.empty()); }

bool B2SData::IsUseLEDs() const { return (!m_leds.empty()); }

bool B2SData::IsUseLEDDisplays() const { return (!m_ledDisplays.empty()); }

bool B2SData::IsUseReels() const { return (!m_reels.empty()); }
