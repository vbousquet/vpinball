...
private:
   ...
   /* Texture* CutOutImage(Texture* pSourceImage, int grillheight, int smallgrillheight);
   Texture* PartFromImage(Texture* pSourceImage, SDL_Rect rect);
   Texture* ResizeImage(Texture* pSourceImage, int grillheight);
   Texture* FlipImage(Texture* pSourceImage);*/
