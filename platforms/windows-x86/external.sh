...
cp libpupdmd/libpupdmd/build/${BUILD_TYPE}/pupdmd.lib ../../../third-party/build-libs/windows-x86
cp libpupdmd/libpupdmd/build/${BUILD_TYPE}/pupdmd.dll ../../../third-party/runtime-libs/windows-x86
