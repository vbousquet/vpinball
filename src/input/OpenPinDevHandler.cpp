                     ...
                     for (const auto &f : col.fields[InputIndex])
                     {
                           ...
                           && strBuf == L"OpenPinballDeviceStruct/"s)
                        {
                           ...
                           auto defaultMapping = [this, deviceId](
                              ...
                              std::function<bool(const SensorMapping&, const SensorMapping&, SensorMapping::Type type)> mapNudge)
                           {
                              bool success = true;
                              ...
                              success &= mapNudge(SensorMapping::Create(deviceId, 0x204, SensorMapping::Type::Velocity), SensorMapping::Create(deviceId, 0x205, SensorMapping::Type::Velocity), SensorMapping::Type::Velocity); // Nudge speed
                              return success;
                           };
                           ...
                           {
                              uint64_t timestampNs = report.timestamp * 1000LL;
