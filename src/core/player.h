...
public:
   ...
   vector<AncillaryRendererDef> m_ancillaryWndRenderers[VPXWindowId::VPXWINDOW_PlayfieldOverlay + 1];
...
private:
   ...
   std::map<string, int, std::less<>> m_ancillaryWndRendererPriorities[VPXWindowId::VPXWINDOW_PlayfieldOverlay + 1];
