...
void VideoOptionPropPage::SaveDisplaySettings()
{
   ...
   const bool saveAll = m_editedSettings == &m_appSettings;
...
void RenderOptPage::LoadSettings(Settings& settings)
{
   ...
   sprintf_s(tmp, sizeof(tmp), "%5.3f", nudgeStrength);
   ...
   sprintf_s(tmp, sizeof(tmp), "%5.3f", trailStrength);
   ...
   { // Stereo
      ...
      sprintf_s(tmp, sizeof(tmp), "%4.1f", stereo3DES);
      ...
      sprintf_s(tmp, sizeof(tmp), "%4.2f", stereo3DBrightness);
      ...
      sprintf_s(tmp, sizeof(tmp), "%4.2f", stereo3DSaturation);
...
void CabinetOptPage::LoadSettings(Settings& settings)
{
   ...
   sprintf_s(tmp, sizeof(tmp), "%5.1f", screenPlayerX);
   ...
   sprintf_s(tmp, sizeof(tmp), "%5.1f", screenPlayerY);
   ...
   sprintf_s(tmp, sizeof(tmp), "%5.1f", screenPlayerZ);
   ...
   sprintf_s(tmp, sizeof(tmp), "%5.1f", screenWidth);
   ...
   sprintf_s(tmp, sizeof(tmp), "%5.1f", screenHeight);
   ...
   sprintf_s(tmp, sizeof(tmp), "%5.3f", screenInclination);
...
void DMDViewOptPage::LoadSettings(Settings& settings)
{
   ...
   m_dmdScaleFX.SetCheck(settings.LoadValueWithDefault(Settings::DMD, "ScaleFXDMD"s, false) ? BST_CHECKED : BST_UNCHECKED);
   LoadDisplaySettings();
   EndLoad();
}
...
void DMDViewOptPage::SaveSettings(Settings& settings, bool saveAll)
{
   ...
   settings.SaveValue(Settings::DMD, "ScaleFXDMD"s, m_dmdScaleFX.GetCheck() == BST_CHECKED, !saveAll);
   SaveDisplaySettings();
}
