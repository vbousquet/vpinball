...
// Generic structure used to identify a ressource belonging to an endpoint
...
typedef enum {
   ...
   CTLPI_GETSEG_LAYOUT_8,          //  7 segments and comma
   CTLPI_GETSEG_LAYOUT_8D,         //  7 segments and dot
   CTLPI_GETSEG_LAYOUT_9,          //  9 segments
   CTLPI_GETSEG_LAYOUT_10,         //  9 segments and comma
   CTLPI_GETSEG_LAYOUT_14,         // 14 segments
   CTLPI_GETSEG_LAYOUT_15,         // 14 segments with dot
   CTLPI_GETSEG_LAYOUT_16,         // 14 segments with dot and comma
   CTLPI_GETSEG_LAYOUT_16R,        // 14 segments with swapped dot and comma
   CTLPI_GETSEG_LAYOUT_16S,        // 16 segments
} SegElementType;
